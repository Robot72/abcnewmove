<?php
/*
  Template Name: grid_view_template
 */
global $wp_query;
...
<?php print_r(wpsc_have_products()) ?>
			...
			<div class="product_grid_item product_view_<?php echo wpsc_the_product_id(); ?>">
				...
				<?php else: ?>
					<div class="item_no_image">
									<a href="<?php echo wpsc_the_product_permalink(); ?>">
									<img class="no-image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php esc_attr_e( 'No Image', 'wp-e-commerce' ); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo WPSC_CORE_THEME_URL; ?>wpsc-images/noimage.png"/>
									</a>
