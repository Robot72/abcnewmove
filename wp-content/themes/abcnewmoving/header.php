...
<div class="map demo-2">
	...
	<div class="full-box">
		<div class="box">
			<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
				<line class="top" x1="0" y1="0" x2="798" y2="0"></line>
				<line class="left" x1="0" y1="54" x2="0" y2="-108"></line>
				<line class="bottom" x1="266" y1="54" x2="-532" y2="54"></line>
				<line class="right" x1="266" y1="0" x2="266" y2="162"></line>
			</svg>
			<h1>ABC New Move</h1>
		</div>
		<div class="clear"></div>
		<div class="box mini-box">
			<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
				<line class="left" x1="0" y1="41" x2="0" y2="-82"></line>
				<line class="bottom" x1="170" y1="41" x2="-340" y2="41"></line>
				<line class="right" x1="170" y1="0" x2="170" y2="123"></line>
			</svg>
			<h2>Moving is simple!</h2>
	...
	<div class="featured">
		<div class="container">
			...
			<h4 class="subtitle" id="map-subtitle">We operate all around greater Vancouver</h4>
			<a class="featured-button featured-button-left" href="http://www.abcnewmoving.com/rent-a-strongbox/">
				<div class="sprite rent-a-strongbox"></div>
				<div class="caption">
					<h4>RENT A STRONGBOX</h4>
					<p>Make your move safer</p>
				</div>
			</a>
			<a class="featured-button featured-button-right" href="http://www.abcnewmoving.com/buy-supplies/">
				<div class="sprite buy-supplies"></div>
				<div class="caption">
					<h4>BUY SUPPLIES</h4>
					<p>Order boxes online</p>
				</div>
			</a>
		</div>
	</div>
