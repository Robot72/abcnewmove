<?php
/*
  Template Name: products_page_template
 */
get_header();
global $wp_query;
...
<?php // Render template created by Nikita: ?>        
...
<?php var_dump( [wpsc_category_name] )?>

<?php if (wpsc_display_products()): ?>

    <?php if (wpsc_is_in_category('boxes')) : ?>
    ...
    <div class="wpsc_default_product_list">
        ...
        <?php while (wpsc_have_products()) : wpsc_the_product(); ?>
            ...
            <?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> 

            <?php if (get_option('hide_name_link') == 1) : ?>
                <?php echo wpsc_the_product_title(); ?>
            <?php else: ?>
                <?php echo esc_url(wpsc_the_product_permalink()); ?><?php echo wpsc_the_product_title(); ?>
            <?php endif; ?>
